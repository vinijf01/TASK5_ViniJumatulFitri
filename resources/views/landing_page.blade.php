        ...
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto">
                ...
                <img data-no-lazy="1"
                    ...
                    alt="qwords.webp" width="140px" height="55px">
            </h1>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link promo-link scrollto" style="margin-top: 1px;"
                            href="https://www.qwords.com/promotion">
                            Promo
                        </a></li>
    ...
    <main id="main">
          ...
          <section id="team" class="team section-bg">
           ...
           <section id="faq" class="faq section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2 style="color: black">Pertanyaan seputar <b style="color: orangered">Layanan Web Hosting</b> Qwords</h2>
                </div>
        ...
        <section id="cta" class="cta">
            <div class="container" data-aos="zoom-in">
                ...
                <div class="row">
                    <div class="col-lg-11 cta-btn-container">
                        <a class="cta-btn align-middlw" href="#">Call To Action</a>
